...
export type SeoPage = 'home' | 'game' | 'about' | 'contact' | 'privacy' | 'terms' | 'buildCareer' | 'simuladorCarreraFutbol'
...
export function PageSeo({ page }: { page: SeoPage }) {
  ...
  useEffect(() => {
    const home = page === 'home'; const game = page === 'game'; const buildCareer = page === 'buildCareer'; const simulator = page === 'simuladorCarreraFutbol'
    ...
    const title = home ? t('home', 'seo.title') : game ? t('home', 'seo.ogTitle') : buildCareerContent ? buildCareerContent.seo.title : simulatorContent ? simulatorContent.seo.title : t('pages', `${page}.seo.title`)
    const description = home ? t('home', 'seo.description') : game ? t('home', 'seo.ogDescription') : buildCareerContent ? buildCareerContent.seo.description : simulatorContent ? simulatorContent.seo.description : t('pages', `${page}.seo.description`)
